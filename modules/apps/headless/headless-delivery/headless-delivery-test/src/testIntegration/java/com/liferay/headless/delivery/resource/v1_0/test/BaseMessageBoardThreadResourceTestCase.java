...
public abstract class BaseMessageBoardThreadResourceTestCase {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPage() throws Exception {
		Long messageBoardSectionId =
			testGetMessageBoardSectionCustomFinderPage_getMessageBoardSectionId();
		Long irrelevantMessageBoardSectionId =
			testGetMessageBoardSectionCustomFinderPage_getIrrelevantMessageBoardSectionId();

		Page<MessageBoardThread> page =
			messageBoardThreadResource.getMessageBoardSectionCustomFinderPage(
		...
		if (irrelevantMessageBoardSectionId != null) {
			MessageBoardThread irrelevantMessageBoardThread =
				testGetMessageBoardSectionCustomFinderPage_addMessageBoardThread(
					irrelevantMessageBoardSectionId,
					randomIrrelevantMessageBoardThread());

			page =
				messageBoardThreadResource.
					getMessageBoardSectionCustomFinderPage(
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithFilterDateTimeEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithFilterDoubleEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithPagination()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithSortDateTime()
		throws Exception {

		testGetMessageBoardSectionCustomFinderPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, messageBoardThread1, messageBoardThread2) -> {
				BeanTestUtil.setProperty(
					messageBoardThread1, entityField.getName(),
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardSectionCustomFinderPageWithSortString()
		throws Exception {
	...
	protected void testGetMessageBoardSectionCustomFinderPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer
				<EntityField, MessageBoardThread, MessageBoardThread, Exception>
					unsafeTriConsumer)
