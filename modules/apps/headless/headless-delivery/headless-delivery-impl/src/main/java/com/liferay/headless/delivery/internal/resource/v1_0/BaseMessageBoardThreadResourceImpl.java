...
public abstract class BaseMessageBoardThreadResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-delivery/v1.0/message-board-sections/{messageBoardSectionId}/custom-finder'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the message board section's threads. Results can be paginated, filtered, searched, and sorted."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/message-board-sections/{messageBoardSectionId}/custom-finder"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<MessageBoardThread> getMessageBoardSectionCustomFinderPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("messageBoardSectionId")
			Long messageBoardSectionId,
